...
const TeamMembers = () => { 
  const teamMembers = [
    {
      id: 1,
      image:{src:"https://i.postimg.cc/YSdMcP6n/Tesfahannes-Tesfay.jpg",alt:'Yohannes Tesfay'},
    ...
    {
      id: 2,
      image:{src:"https://i.postimg.cc/MKgY5Zgt/Salem-Blue.png",alt:'Selam hayelom'},
      name: 'Selam hayelom',
      role: 'HR officer',
    ...
    {
        id: 3,
        image:{src:"https://i.postimg.cc/fyLv2Vwq/Geleta-Kedir-233x300.jpg",alt:'Adane Haile'},
        name: 'Adane Haile',
        role: 'Sales Man',
    ...
    {
        id: 4,
        image:{src:"https://i.postimg.cc/wBpQKfqm/Elias-Meseret.webp",alt:'Elias Meseret'},
        name: 'Elias meseret',
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {teamMembers.map((member) => (
          <div key={member.id} className="bg-white rounded-lg shadow-lg p-6">
            <img src={member.image.src} alt={member.image.alt} className='border-2 mx-auto w-[300px] h-[300px] rounded-lg'/>
